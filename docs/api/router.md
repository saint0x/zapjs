...
The `@zap-js/client` package provides file-based routing using TanStack Router-style conventions. It automatically discovers routes from your filesystem and generates type-safe route manifests.
...
```typescript
import { RouteScanner } from '@zap-js/client';
...
```typescript
import { generateRouteTree } from '@zap-js/client';
...
**routeTree.ts**
```typescript
// Auto-generated by @zap-js/client
...
```typescript
import { RouteWatcher } from '@zap-js/client';
...
```typescript
import { watchAndRegenerate } from '@zap-js/client';
...
```typescript
import { flattenRoutes } from '@zap-js/client';
...
```typescript
import { findParentLayout } from '@zap-js/client';
...
```typescript
import { generateRustManifest } from '@zap-js/client';
